...
data class SearchAnimals @Inject constructor(
    ...
    operator fun invoke(
        ...
        return Observable
            .combineLatest(query, age, type, combiningFunction)
            .toFlowable(BackpressureStrategy.LATEST)
            .switchMap { params: SearchParameters ->
                repository.searchCachedAnimalsBy(params)
            }
    }
